...
class AIProcessor:
    def __init__(self, model_path: str = r"C:\mt5_arabic_summarizer1"):
        ...
        self.labels = ["culture", "finance", "medical", "Artificial Intelligence", "sport", "announcements"]

        # === 3. Text Vector (SBERT) ===
        self.sbert = SentenceTransformer("sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")
    ...
    def get_text_vector(self, text: str) -> list:
        ...
        return embedding[0].tolist()  # تحويل إلى list قابل للـ JSON
