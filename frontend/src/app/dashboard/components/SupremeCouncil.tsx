...
const STAKEHOLDER_TYPE = 'supreme_council'
const STAKEHOLDER_ID = 2
    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-stone-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 pt-24 pb-12 px-4">
      <div className="max-w-3xl mx-auto text-center">
        <div className="mb-10">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-stone-800 dark:text-white mb-2">Supreme Council Dashboard</h1>
          <p className="text-stone-500 dark:text-stone-400 text-sm">Supreme Council for Higher Education</p>
        </div>
