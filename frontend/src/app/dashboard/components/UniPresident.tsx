...
const STAKEHOLDER_TYPE = 'president'
const STAKEHOLDER_ID = 5 
    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-stone-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 pt-24 pb-12 px-4">
      <div className="max-w-3xl mx-auto text-center">
        <div className="mb-10">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-stone-800 dark:text-white mb-2">University President Dashboard</h1>
        </div>
