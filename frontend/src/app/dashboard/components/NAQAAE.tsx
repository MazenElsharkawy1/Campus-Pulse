...
const STAKEHOLDER_TYPE = 'naqaae'
const STAKEHOLDER_ID = 6
const MEDIA_ADVISER_ID = 7
...
// ============================================================
// 🔧 MAIN: NAQAAEDashboard
// ============================================================
export default function NAQAAEDashboard() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-stone-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 pt-24 pb-12 px-4">
      <div className="max-w-3xl mx-auto text-center">
        <div className="mb-10">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-stone-800 dark:text-white mb-2">NAQAAE Dashboard</h1>
          <p className="text-stone-500 dark:text-stone-400 text-sm">National Authority for Quality Assurance & Accreditation</p>
        </div>
